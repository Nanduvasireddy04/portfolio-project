    ...
    <div className="container">
      <div className="about-section">
        ...
        <div className="content">
          ...
          <p>Data Engineer &nbsp;|&nbsp; Analytics Engineer &nbsp;|&nbsp; Data Scientist</p>
          <p className="tagline">
            3+ years building scalable data pipelines, cloud-native analytics platforms,
            and ML systems — across fintech, healthcare, and community tech.
          </p>
